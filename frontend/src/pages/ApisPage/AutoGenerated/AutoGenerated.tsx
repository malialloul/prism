    ...
    return (
      <ApisContent>
        <Box sx={{ display: 'flex', height: '100%' }}>
          ...
          <Box sx={{ width: 320, borderRight: '1px solid', borderColor: 'divider', p: 2, display: 'flex', flexDirection: 'column', gap: 1 }}>
            {[1, 2, 3, 4].map((i) => (
              <Box key={i}>
                <Skeleton variant="rectangular" height={48} sx={{ borderRadius: 1, mb: 1 }} />
                {[1, 2, 3, 4, 5].map((j) => (
                  <Skeleton key={j} variant="rectangular" height={36} sx={{ borderRadius: 1, mb: 0.5, ml: 2 }} />
                ))}
              </Box>
            ))}
          </Box>
          {/* Try it panel skeleton */}
          <Box sx={{ flex: 1, p: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Skeleton variant="rectangular" height={200} sx={{ borderRadius: 1, flex: 1 }} />
          </Box>
        </Box>
      </ApisContent>
    );
